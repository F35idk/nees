...
impl Cpu {
    ...
    pub fn exec_instruction(&mut self, memory: &mut mmap::Nrom128MemoryMap) -> u8 {
    ...
    fn get_indexed_indirect(&self, addr: u8, memory: &mmap::Nrom128MemoryMap) -> u16 {
    ...
    fn get_indirect_indexed(&self, addr: u8, memory: &mmap::Nrom128MemoryMap) -> (u16, bool) {
    ...
    fn brk(&mut self, memory: &mut mmap::Nrom128MemoryMap) {
    ...
    fn jsr(&mut self, addr: u16, memory: &mut mmap::Nrom128MemoryMap) {
    ...
    fn push_val(&mut self, val: u8, memory: &mut mmap::Nrom128MemoryMap) {
        self.pc += 1;
    ...
    fn pull_val(&mut self, memory: &mut mmap::Nrom128MemoryMap) -> u8 {
        self.pc += 1;
    ...
    fn rti(&mut self, memory: &mut mmap::Nrom128MemoryMap) {
    ...
    fn rts(&mut self, memory: &mut mmap::Nrom128MemoryMap) {
    ...
    pub fn debug_exec_opcode(&mut self, opc: [u8; 3], memory: &mut mmap::Nrom128MemoryMap) -> u8 {
